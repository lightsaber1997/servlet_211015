...
Map<String, Object> music_info = null;
if (id_ != null) {
	
	int id = Integer.parseInt(id_);
	
	for (Map<String, Object> map: musicList) {
		if (id == (int) map.get("id")) {
			music_info = map;
			break;
		}
	}
	...
	<div class="container">
		...
		<div>
			...
			<div class="border border-success d-flex p-2">
				<img class="col-3" src="<%= music_info.get("thumbnail") %>">
				<div class="col-8 ">
					<p class="display-4"><%= music_info.get("title") %></p>
					<p class="text-success font-weight-bold"><%= music_info.get("singer") %></p>
					<table>
						<tr>
							<td>앨범</td>
							<td><%= music_info.get("album") %></td>
						</tr>
						<tr>
							<td>재생시간</td>
							<td><%= music_info.get("time") %></td>
						</tr>
						<tr>
							<td>작곡가</td>
							<td><%= music_info.get("composer") %></td>
						</tr>
						<tr>
							<td>작사가</td>
							<td><%= music_info.get("lyricist") %></td>
						</tr>
					</table>
				</div>
